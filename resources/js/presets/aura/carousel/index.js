export default {
    ...
    previousbutton: {
        class: [
            ...
            // States
            'hover:bg-surface-50 light:hover:bg-surface-800',
            'focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-primary-500 light:focus-visible:ring-primary-400',
    ...
    indicatorbutton: ({ context }) => ({
        class: [
            ...
            // Color & Background
            {
                'bg-surface-200 hover:bg-surface-300 light:bg-surface-700 light:hover:bg-surface-600': !context.highlighted,
