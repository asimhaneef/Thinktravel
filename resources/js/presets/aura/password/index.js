export default {
    ...
    meterlabel: ({ instance }) => ({
        class: [
            ...
            // Colors
            {
                'bg-red-500 light:bg-red-400/50': instance?.meter?.strength == 'weak',
                'bg-orange-500 light:bg-orange-400/50': instance?.meter?.strength == 'medium',
                'bg-green-500 light:bg-green-400/50': instance?.meter?.strength == 'strong'
            },
    ...
    showicon: {
        class: ['absolute top-1/2 right-3 -mt-2 z-10', 'text-surface-600 light:text-white/70']
    },
    hideicon: {
        class: ['absolute top-1/2 right-3 -mt-2 z-10', 'text-surface-600 light:text-white/70']
    },
