export default {
    root: ({ props }) => ({
        class: [
            ...
            {
                'text-white light:text-surface-900': props.target === 'parent',
                'text-surface-0': props.target === 'window',
                'bg-primary': props.target === 'parent',
                'bg-surface-600 light:bg-surface-700 hover:bg-surface-700 light:hover:bg-surface-600': props.target === 'window'
            },

            // States
            {
                'hover:bg-primary-hover': props.target === 'parent',
                'hover:bg-surface-600 light:hover:bg-surface-300': props.target === 'window'
            }
        ]
    }),
    transition: {
