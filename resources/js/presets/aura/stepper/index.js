    ...
    stepperpanel: {
        ...
        number: ({ context }) => ({
            class: [
                ...
                //Colors
                'border-solid border-2 border-surface-200 light:border-surface-700',

                // Colors (Conditional)
                context.active ? 'text-primary' : 'text-surface-900 light:text-surface-0', // Adjust colors as needed
        ...
        title: ({ context }) => ({
            class: [
                ...
                // Text
                context.active ? 'text-primary' : 'text-surface-700 light:text-surface-0/80',
                'font-medium',
        ...
        separator: ({ context, state, parent }) => ({
            class: [
                ...
                state.d_activeStep <= context.index ? 'bg-surface-200 light:bg-surface-700' : 'bg-primary',
        ...
        transition: {
            class: ['flex flex-1', 'bg-surface-0 light:bg-surface-900', 'text-surface-900 light:text-surface-0'],
