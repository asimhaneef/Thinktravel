export default {
    ...
    menu: ({ props }) => ({
        class: [
            ...
            // Color
            'bg-surface-0 light:bg-surface-900 sm:bg-transparent light:sm:bg-transparent',
    ...
    menubutton: {
        class: [
            ...
            'rounded-full',
            // Color
            'text-surface-500 light:text-white/80',

            // States
            'hover:text-surface-600 light:hover:text-white/60',
            'hover:bg-surface-100 light:hover:bg-[rgba(255,255,255,0.03)]',
            'focus:outline-none focus:outline-offset-0',
            'focus:ring-1 focus:ring-primary-500 light:focus:ring-primary-400',
