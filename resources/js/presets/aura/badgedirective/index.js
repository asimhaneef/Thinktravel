    ...
    root: ({ context }) => ({
        class: [
            ...
            'text-primary-inverse',
            {
                ...
                'bg-surface-500 light:bg-surface-400': context.secondary,
                'bg-green-500 light:bg-green-400': context.success,
                'bg-blue-500 light:bg-blue-400': context.info,
                'bg-orange-500 light:bg-orange-400': context.warning,
                'bg-purple-500 light:bg-purple-400': context.help,
                'bg-red-500 light:bg-red-400': context.danger
            }
        ]
    })
};
