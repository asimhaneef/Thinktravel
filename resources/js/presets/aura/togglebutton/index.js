export default {
    ...
    box: ({ props }) => ({
        class: [
            ...
            {
                'text-surface-600 light:text-white/60 before:bg-transparent': !props.modelValue,
                'text-surface-800 light:text-white/80 before:bg-surface-0 light:before:bg-surface-800': props.modelValue
            },
            ...
            // States
            {
                'peer-hover:text-surface-800 light:peer-hover:text-white/80': !props.disabled && !props.modelValue,
