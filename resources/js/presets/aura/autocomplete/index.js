export default {
    root: ({ props }) => ({
        class: [
            ...
            // Color
            'text-surface-900 light:text-surface-0',
    ...
    input: ({ props, parent }) => ({
        class: [
            ...
            'border',
            {
                'bg-surface-0 light:bg-surface-950': !props.multiple,
                ' border-surface-300 light:border-surface-700': !props.multiple && !props.invalid,
            ...
            // States
            { 'focus:outline-none focus:outline-offset-0 focus:ring-1 focus:ring-primary-500 light:focus:ring-primary-400 focus:z-10': !props.multiple },
    ...
    loadingicon: {
        class: ['text-surface-500 light:text-surface-0/70', 'absolute top-[50%] right-[0.5rem] -mt-2 animate-spin']
    },
    panel: {
        class: [
            // Colors
