export default {
    root: ({ props }) => ({
        class: [
            ...
            // Colors
            'bg-surface-200 light:bg-surface-800',
    ...
    handle: ({ props }) => ({
        class: [
            ...
            'before:block before:w-[16px] before:h-[16px] before:rounded-full before:bg-surface-0 light:before:bg-surface-950 before:shadow-md',
            ...
            'ring-primary-500 light:ring-primary-400',
