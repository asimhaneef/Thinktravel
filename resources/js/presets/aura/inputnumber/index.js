export default {
    root: ({ props, parent }) => ({
        class: [
            ...
            { 'border-0 border-y border-l last:border-r border-surface-300 light:border-surface-700': parent.instance.$name == 'InputGroup' && !props.showButtons },
    ...
    input: {
        root: ({ parent, context }) => ({
            class: [
                ...
                'border',
                { 'border-surface-300 light:border-surface-700': !parent.props.invalid },

                // Invalid State
                'invalid:focus:ring-red-200',
                'invalid:hover:border-red-500',
                { 'border-red-500 light:border-red-400': parent.props.invalid },
    ...
    incrementbutton: {
        root: ({ parent }) => ({
            class: [
                ...
                //Color
                'text-surface-800 light:text-surface-0',
                'bg-transparent',
                { 'light:bg-surface-900': parent.props.showButtons && parent.props.buttonLayout !== 'stacked' },
