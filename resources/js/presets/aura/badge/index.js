    ...
    root: ({ props }) => ({
        class: [
            ...
            'text-primary-inverse',
            {
                ...
                'bg-surface-500 light:bg-surface-400': props.severity == 'secondary',
                'bg-green-500 light:bg-green-400': props.severity == 'success',
                'bg-blue-500 light:bg-blue-400': props.severity == 'info',
                'bg-orange-500 light:bg-orange-400': props.severity == 'warning',
                'bg-purple-500 light:bg-purple-400': props.severity == 'help',
                'bg-red-500 light:bg-red-400': props.severity == 'danger'
            }
        ]
    })
};
