<template>
    <section class="section-height-700 breadcrumb-modern rd-parallax context-black bg-gray-darkest image_mobile">	  
      <div id="header_img_vacations" data-speed="0.2" data-type="media" data-url="images/backgrounds/background-02-1920x950.jpg"  class="rd-parallax-layer"></div>			
            ...
            <div class="shell section-top-50 section-bottom-34 section-md-top-90 section-lg-bottom-34 section-lg-top-128">              
                   <div class="cell-sm-10 cell-lg-8 cell-xl-5" >
                      <div class="veil reveal-md-block"   >
                        <h5 class="reveal-inline-block font-default both-lines text-italic" style="color:white;">The Best Vacation for You</h5>
                      </div>
                      <div class="veil reveal-md-block offset-top-8"  >
                        <h1 class="text-bold" style="color:#ffa200;display:block;"  >Vacation Packages</h1>
                      </div>
                  </div>
            </div>
          </div>
                              ...
                              <div style="margin-left:20px;margin-right:20px;">
                                  ...
                                  <div class="mt-3 row">                               
                                    ...
                                    <div class="form-group col-md-6">
                                      <label for="vacation_origin" class="form-label-outside text-black">Origin *</label>
                                    ...
                                    <div class="form-group col-md-6">
                                      <label for="vacation_destination" class="form-label-outside text-black">Destination (Country)*</label>
                                    ...
                                    <div class="form-group col-md-6">
                                      ...
                                      <input id="departing_date_twoway" type="date" v-model="form.vacation_departing_date" class="form-control date_input" style="background-color:white;" required value="" />
                                    </div>
                                    <div class="form-group col-md-6">
                                      <label for="vacation_total_days" class="form-label-outside text-black">Duration</label>
                                      <select v-model="form.vacation_total_days" id="vacation_total_days" required class="form-control" style="background-color:white;"  >
                                        <option value="" >--Select--</option>
                                        <option value="3 to 4" >3 to 4</option>
                                        <option value="5 to 10" >5 to 10</option>
                                        <option value="11 to 16" >11 to 16</option>
                                        <option value="17 or More" >17 or More</option>
                                ...
                                <div class="row">
                                  <div class="form-group col-md-6" >
                                    <label for="vacation_flexibility" class="form-label-outside text-black">Felxibility</label>
                                    <br>
                                    <div style="background-color:white;" class="form-control">
                                      <input type="radio" v-model="form.vacation_flexibility" id="vacation_flexibility" value="1day" /> + / - 1 Day &nbsp;&nbsp;&nbsp; 
                                      <input type="radio" v-model="form.vacation_flexibility" id="vacation_flexibility" value="3days" /> + / -3 Days
                                    </div>
                                  </div>
                                  <div class="form-group col-md-6">
                                    <label for="vacation_preferred_airline" class="form-label-outside text-black">Preferred Tour Company</label>
                                    <select v-model="form.vacation_preferred_airline" id="vacation_preferred_airline" class="form-control" style="background-color:white;" >
                                        <option value="" >--Select--</option>
                                        <option value="Transat" > Transat </option>
                                        <option value="Sunwing" > Sunwing </option>
                                        <option value="Sunquest" > Sunquest </option>
                                        <option value="Signature" > Signature </option>
                                        <option value="Westjet" > Westjet </option>
                                        <option value="TravelBrands" > TravelBrands </option>
        ...
        methods: {
          ...
          async getCountries() {
                try {
                    ...
                    this.countries = response.data.data;// Find the default country where is_default is 1
