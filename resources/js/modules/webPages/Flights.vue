<template>
  ...
  <div id="header_img_flights" data-speed="0.2" data-type="media" data-url="images/backgrounds/background-06-1920x950.jpg" class="rd-parallax-layer"></div>
      ...
      <div class="shell section-top-50 section-bottom-34 section-md-top-90 section-lg-bottom-34 section-lg-top-128">
        <div class="cell-sm-10 cell-lg-8 cell-xl-5">
          <div class="veil reveal-md-block">
            <h5 class="reveal-inline-block font-default both-lines text-italic" style="color:white;">The Best Flight for You</h5>
          </div>
          <div class="veil reveal-md-block offset-top-8">
            <h1 class="text-bold" style="color:#ffa200;display:block;">Flights</h1>
          </div>
        </div>
      </div>
    </div>
                          ...
                          <div style="margin-left:20px;margin-right:20px;">
                            <div class="row">
                              <div class="form-group col-md-12">
                                <label for="flying_type" class="form-label-outside text-black">Type *</label>
                                <input id="flying_type" type="radio" value="return" v-model="form.flying_type" />Return
                                <input id="flying_type" type="radio" value="one-way" v-model="form.flying_type" />One Way
                                <input id="flying_type" type="radio" value="multicity" v-model="form.flying_type" />Multicity
                              </div>
                              
                            </div>
                              <div v-for="(detail, index) in form.flight_details" :key="index" class="mt-3 row">
                                


                                <div class="form-group col-md-6">
                                  <label :for="'flying_from_' + index" class="form-label-outside text-black">Flying From *</label>
                                ...
                                <div class="form-group col-md-6">
                                  <label for="flying_to" class="form-label-outside text-black">Flying To *</label>
                                ...
                                <div class="form-group col-md-6">
                                  <label class="form-label-outside text-black">Departing Date *</label>
                                  <input id="departing_date_twoway" type="date" v-model="detail.departing_date" class="form-control date_input" style="background-color:white;" required value="" />
                                </div>
                                <div class="form-group col-md-6" v-if="form.flying_type === 'return'">
                                  <label class="form-label-outside text-black">Returning Date *</label>
                                  <input id="returning_date_twoway" type="date" v-model="detail.returning_date" class="form-control date_input" onchange="validate_return_date('twoway')" style="background-color:white;" required value="" />
                                </div>
                                <div class="form-group col-md-6">
                                  <label class="form-label-outside text-black">Preferred Airline</label>
                                  <select v-model="detail.preferred_airline" id="preferred_airline" class="form-control" style="background-color:white;">
                                    <option value="">--Select--</option>
                                ...
                                <div class="form-group col-md-6" v-if="form.flying_type === 'return'">
                                  <label for="registration-last-name" class="form-label-outside text-black">Felxibility</label>
                                  <br>
                                  <div style="background-color:white;" class="form-control">
                                    <input type="radio" v-model="detail.flexibility" id="flexibility" value="1day" /> + / - 1 Day &nbsp;&nbsp;&nbsp; 
                                    <input type="radio" v-model="detail.flexibility" id="flexibility" value="3days" /> + / -3 Days
                                  </div>
                                </div>
                            ...
                            <input type="button" id="btn_add_flight" @click="addFlightDetail" value="+ Add Another Flight" v-if="form.flying_type === 'multicity'">
                            <div class="row">
                            ...
                            <div class="row offset-top-20">
                              <div class="form-group col-md-4"> Add Hotel &nbsp;&nbsp; 
                                <input id="add_hotel_twoway" type="checkbox" style="background-color:white;" value="Yes" v-model="form.add_hotel" />
                              </div>
                            ...
                            <div id="div_add_hotel_twoway" v-if="form.add_hotel">
                              <div class="row">
                                <div class="form-group col-md-6">
                                  <label class="form-label-outside text-black">Check In Date</label>
                                ...
                                <div class="form-group col-md-6">
                                  <label class="form-label-outside text-black">Check Out Date</label>
...
export default {
    ...
    data() {
        return {
            form: new Form({
              flying_type: 'return',
              flight_details: [ // Dynamic section for receipt details
                    {
                        flying_from: '',
                        flying_to: '',
                        departing_date: '',
