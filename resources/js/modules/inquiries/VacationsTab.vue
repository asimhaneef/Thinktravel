<template>
    ...
    <DataTable :value="vacationInquiries" :rows="rows" scrollable scrollHeight="400px"  filterDisplay="menu"
    sortMode="multiple" tableStyle="min-width: 50rem" :loading="loading"
        ...
        <!-- Add other columns specific to vacations -->
    </DataTable>
    <!-- Paginator Component -->
    ...
    <Sidebar v-model:visible="visibleRight" :header="form.id ? 'Update Inquiry' : 'Add Inquiry'" position="right"
        ...
        <form class="mt-3" @submit.prevent="saveEnquiry()"
            ...
            <div class="row">
                    ...
                    <div class="form-group col-md-3">
                        <label for="vacation_origin" class="form-label-outside">Origin</label> 
                        <Dropdown
                            v-model="form.vacation_origin"
                            :options="airports"
                            optionLabel="label"
                            optionValue="value"
                    ...
                    <div class="form-group col-md-3">
                        <label for="vacation_destination" class="form-label-outside">Destination (Country)</label> 
                        <Dropdown
                            v-model="form.vacation_destination"
                            :options="countries"
                            optionLabel="country"
                            optionValue="id"
                    ...
                    <div class="form-group col-md-3">
                        <label for="vacation_total_days" class="form-label-outside">Duration</label>
                ...
                <div class="form-group col-md-3">
                    ...
                    <input id="departing_date" type="date" v-model="form.vacation_departing_date" class="form-control date_input" style="background-color:white;" required value="" />
                </div>
                <div class="form-group col-md-3">
                ...
                <div class="form-group col-md-3">
                    ...
                    <input type="radio" v-model="form.vacation_flexibility" id="flexibility" value="1day" /> + / - 1 Day &nbsp;&nbsp;&nbsp; 
                    <input type="radio" v-model="form.vacation_flexibility" id="flexibility" value="3days" /> + / -3 Days
                    </div>
                </div>
                <div class="form-group col-md-3" >
                ...
                <div class="form-group col-md-2">
                    <label for="usa_connection">&nbsp;</label>
    ...
    methods: {
        ...
        async getInquiries() {
            try {
                ...
                const vacationResponse = await axios.get("/api/vacation-inquiry",{
                    params: {
                ...
                this.vacationInquiries = vacationResponse.data.data;
                this.totalRecords = vacationResponse.data.total;
                this.loading = false;
            } catch (error) {
        ...
        async showSidebar(inquiry) {
            ...
            if (inquiry) {
                ...
                this.form.fill({
                    ...
                    vacation_origin: inquiry.vacation_origin.id,
                    vacation_destination: inquiry.vacation_destination.id,
